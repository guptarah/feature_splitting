...
def sim_anneal(w,X,targets,eta,one_in_k_enc,cur_feat_indic,sim_anl_prob,sample_wts):
	...
	probability,obt_classes,accuracy1,equals1 = get_accuracy(cur_wts_new1,cur_data1,targets,sample_wts)
	...
	probability,obt_classes,accuracy2,equals2 = get_accuracy(cur_wts_new2,cur_data2,targets,sample_wts)
